    ...
    <aside className="app-sidebar" id="sidebar">
      ...
      <div className="sidebar-header">
        ...
        <div className="sidebar-brand">
          <span className="sidebar-brand-name">CampusVoice</span>
      ...
      <nav className="sidebar-nav">
        ...
        <div className="sidebar-section">
          <div className="sidebar-section-title">Survey Management</div>
          ...
          <div className="sidebar-link disabled" title="Inactive for profiling activity">
            ...
            <span className="sidebar-link-text">Surveys</span>
          </div>
          ...
          <div className="sidebar-link disabled" title="Inactive for profiling activity">
            ...
            <span className="sidebar-link-text">Results</span>
          </div>
        ...
        {/* USER MANAGEMENT SECTION (ACTIVE STUDENTS ONLY) */}
        <div className="sidebar-section">
      ...
      <div className="sidebar-footer">
        <div className="sidebar-link logout-btn disabled">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
